...
There are two types of data programs currently available through the [AIMS Data Platform API](https://open-aims.github.io/data-platform): [Weather](https://doi.org/10.25845/5c09bf93f315d), which contains multiple datasets for different variables (e.g. Air Temperature, Air Pressure, Chlorophyll, and many others), and [Sea Water Temperature Loggers](https://doi.org/10.25845/5b4eb0f9bb848), which contains multiple datasets of (you guessed it!) sea water temperature at different sites and water depths. They are queried via unique DOI identifiers.

For the purposes of this example, we will query the [AIMS Weather](https://doi.org/10.25845/5c09bf93f315d). To explore this data program, we use the function `filter_values`. This function takes a DOI and a given parameter filter, and returns all the available information regarding the filter. For the Weather data sets, a list of available filter parameters can be found [here](https://doi.org/10.25845/5c09bf93f315d/index). We recommend exploring the parameter `series`:
...
series    | 64                     | Found [here](https://doi.org/10.25845/5c09bf93f315d/series), Davies Reef Air Temperature data series
