...
#> 
#> $filters
#>  [1] "site"      "subsite"   "series"    "series_id" "parameter" "size"      "min_lat"   "max_lat"   "min_lon"  
#> [10] "max_lon"   "from_date" "thru_date" "version"   "cursor"
```
...
head(sdata)
#>   site_id                    site subsite_id    subsite series_id     series         parameter parameter_id
#> 1       1 Agincourt Reef Number 3       2687     AG3FL1      2687     AG3FL1 Water Temperature            1
#> 2       1 Agincourt Reef Number 3      14276  AG3SL1old     14276  AG3SL1old Water Temperature            1
#> 3       3           Cleveland Bay       3007 CLEVAWSSL1      3007 CLEVAWSSL1 Water Temperature            1
#> 4       3           Cleveland Bay       3069 CLEVAWSFL1      3069 CLEVAWSFL1 Water Temperature            1
#> 5       4             Davies Reef       2629     DAVFL1      2629     DAVFL1 Water Temperature            1
#> 6       4             Davies Reef       2630     DAVSL1      2630     DAVSL1 Water Temperature            1
#>   time_coverage_start time_coverage_end      lat      lon depth uncal_obs cal_obs qc_obs
#> 1          1996-03-30        2008-12-11 -15.9903 145.8212     0     23130  110480 110480
#> 2          1996-03-30        2011-07-21 -15.9905 145.8213     5    114450  216794 216794
#> 3          2004-05-13        2008-05-03 -19.1557 146.8813     7     11951   53231  53231
#> 4          2005-09-15        2005-12-22 -19.1557 146.8813     1         0    4656   4656
#> 5          1997-08-26        2019-06-10 -18.8065 147.6688     1    437544  566585 566585
#> 6          1996-05-02        2021-03-29 -18.8060 147.6686     8    463146  589492 589437
```
...
head(ddata)
#>   deployment_id serial_num site_id             site subsite_id subsite series_id  series         parameter
#> 1          2616 SST-905084     860 Black Rocks Reef       2616  BLAFL1      2616  BLAFL1 Water Temperature
#> 2          2612 SST-905053     856       Cattle Bay       2612   CBFL2      2612   CBFL2 Water Temperature
#> 3          2613 SST-905054     857     Raine Island       2613 RAIDSL1      2613 RAIDSL1 Water Temperature
#> 4          2620 SST-905189     863       Kelso Reef       2620  KELSL1      2620  KELSL1 Water Temperature
#> 5          2619 SST-905091     863       Kelso Reef       2619  KELFL1      2619  KELFL1 Water Temperature
#> 6          2621 SST-905068     865    Hayman Island       2621  HAYFL1      2621  HAYFL1 Water Temperature
#>   parameter_id time_coverage_start time_coverage_end      lat      lon depth uncal_obs cal_obs qc_obs
#> 1            1          1996-07-20        1997-01-19 -16.2445 145.4872   0.1      8728    8728   8728
#> 2            1          1998-11-19        1999-03-02 -18.5719 146.4833   4.0      4896    4896   4896
#> 3            1          1996-11-28        1997-10-09 -11.5898 144.0309  20.0         0   15062  15062
#> 4            1          1997-08-25        1998-04-18 -18.4221 146.9846   7.0     11278   11278  11278
#> 5            1          1997-08-25        1998-04-18 -18.4448 146.9933   2.0     11278   11278  11278
#> 6            1          1997-05-12        1998-04-21 -20.0413 148.8819   2.0     16460   16460  16460
```
