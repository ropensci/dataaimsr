...
[![Codecov test coverage](https://codecov.io/gh/ropensci/dataaimsr/branch/master/graph/badge.svg)](https://codecov.io/gh/ropensci/dataaimsr?branch=master)
...
At this stage `dataaimsr` is not hosted on CRAN R package network, although
we re aiming to submit it there very soon. For the moment, an alternative
method of installation is to use the R `remotes` package. R `remotes` can be
