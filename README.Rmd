...
`dataaimsr` is the **AIMS Data Platform R Client**, and will provide you with easy access to data sets from the [AIMS Data Platform API](https://open-aims.github.io/data-platform).
