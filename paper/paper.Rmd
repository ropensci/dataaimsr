...
```{r tssa, echo = FALSE, out.width = "100%", fig.cap="(ref:fig-tssa)", cache = TRUE}
knitr::include_graphics("tssa.png")
```
...
```{r tssb, echo = FALSE, out.width = "100%", fig.cap="(ref:fig-tssb)", cache = TRUE}
knitr::include_graphics("tssb.png")
```
