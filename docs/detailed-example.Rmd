...
This example assumes you have stored an *AIMS DataPlatform API Key* in your `.Renviron` file.  See [here](index#usage-of-aims-dataplatform-api-key) to see what that means.

Similar to our previous example we want to run a plot on a series, lets discover a series to plot.
...
```{r}
results <- getAllData('10.25845/5c09bf93f315d', filters=list('series'=4067, 'from-date'='2018-01-01', 'thru-date'='2018-01-07'))
```
...
```{r}
results2 <- getData(aimsWeather, filters=list('series'=87929, 'from-date'='2018-01-01', 'thru-date'='2018-01-07'))
